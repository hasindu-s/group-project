<?php
    ...
    $start = ($page - 1) * $limit;
    $result = $con->query('SELECT original_title, title, authors, average_rating, image_url FROM books LIMIT '.$start.', '.$limit);
...
<body>
    ...
    <div class="small-container">
        ...
        <div class="page-btn">
            <a href="testbook1.php?page=<?php if ($page <= 1) {
                                                        echo 1;
                                                    }
                                                    else
                                                        echo $previous; ?>"><span>&#8592;</span></a>
            <?php for($i = 1; $i <= 10; $i++) : ?>
                <a href="testbook1.php?page=<?= $i; ?>">
                    <span 
                        <?php 
                            if ($page == $i) {
                                echo 'style="background: #ff523b;color: #fff;"';
                            }
                        ?>
                    >
                        <?= $i; ?>
            ...
            <?php endfor; ?>
            <a href="testbook1.php?page=<?php if ($page >= 10) {
                                                    echo 10;
                                                }
                                                else
                                                    echo $next; ?>"><span >&#8594;</span></a> 
